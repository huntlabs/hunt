...
module hunt.concurrent.ForkJoinTask;
 ...
 * @author Doug Lea
 */
abstract class ForkJoinTask(V) : Future!(V) {
     ...
     */
    static final class ExceptionNode : WeakReference<ForkJoinTask<?>> {
        final Throwable ex;
        ExceptionNode next;
...
static <T extends Throwable>
     ...
     * @return the task
     */
    static !(T) ForkJoinTask!(T) adapt(Callable!(T) callable) {
