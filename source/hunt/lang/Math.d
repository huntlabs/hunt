...
public final class Math {
     ...
     */
    public enum double E = 2.7182818284590452354;
     ...
     * diameter.
     */
    public enum double PI = 3.14159265358979323846;

    /**
     * Constant by which to multiply an angular value in degrees to obtain an
     * angular value in radians.
     */
    private enum double DEGREES_TO_RADIANS = 0.017453292519943295;

    /**
     * Constant by which to multiply an angular value in radians to obtain an
     * angular value in degrees.
     */
    private enum double RADIANS_TO_DEGREES = 57.29577951308232;
    ...
    public static int floorMod(long x, int y) {
        ...
        return cast(int)(x - floorDiv(x, y) * y);
    }
