...
class CertificateFactory {
     ...
     */
    protected this(CertificateFactorySpi certFacSpi,
    ...
    static final CertificateFactory getInstance(string type) {
        try {
            return new CertificateFactory(getFactorySpi(type),
                null, type);
    ...
    static CertificateFactorySpi getFactorySpi(string type)
    {
        if(type == "X.509")
        {
     ...
     * @since 1.4
     */
    final CertPath generateCertPath(List!Certificate certificates)
    {
     ...
     * @exception CertificateException on parsing errors.
     */
    final Collection!Certificate generateCertificates(InputStream inStream) {
     ...
     * @exception CRLException on parsing errors.
     */
    final Collection!CRL generateCRLs(InputStream inStream) {
