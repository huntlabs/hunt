 ...
 * key certificates or Kerberos server tickets are stored
 * within a credential {@code Set}.  Different permissions
 ...
 * all the or private credentials belonging to a {@code Subject},
...
class Subject {
    ...
    private enum serialVersionUID = -8308522755600156056L;
    ...
    // private enum int PRINCIPAL_SET = 1;
    // private enum int PUB_CREDENTIAL_SET = 2;
    // private enum int PRIV_CREDENTIAL_SET = 3;

    // // private __gshared ProtectionDomain[] NULL_PD_ARRAY;
    ...
    //  * Sets of and private credentials.
    //  *
    ...
    //  * To modify the credential Set, the caller must have
    ...
    //  *
    //  * @param pubCredentials the {@code Set} of credentials
    //  *          to be associated with this {@code Subject}. <p>
    //  *
    ...
    // // private static AccessControlContext createContext(Subject subject,
    ...
    // /**
    //  * Return the {@code Set} of credentials held by this
    //  * {@code Subject}.
    //  *
    //  * <p> The returned {@code Set} is backed by this Subject's
    //  * internal Credential {@code Set}.  Any modification
    //  * to the returned {@code Set} affects the internal public
    //  * Credential {@code Set} as well.
    //  *
    //  * <p>
    //  *
    //  * @return  A {@code Set} of credentials held by this
    //  *          {@code Subject}.
    //  */
    ...
    // /**
    //  * Return a {@code Set} of credentials associated with this
    //  * {@code Subject} that are instances or subclasses of the specified
    //  * {@code Class}.
    //  *
    //  * <p> The returned {@code Set} is not backed by this Subject's
    //  * internal Credential {@code Set}.  A new
    //  * {@code Set} is created and returned for each method invocation.
    //  * Modifications to the returned {@code Set}
    //  * will not affect the internal Credential {@code Set}.
    //  *
    //  * <p>
    //  *
    //  * @param <T> the type of the class modeled by {@code c}
    //  *
    //  * @param c the returned {@code Set} of credentials will all be
    //  *          instances of this class.
    //  *
    //  * @return a {@code Set} of credentials that are instances
    ...
    //     try {
    //         return cast(int)o.toHash();
    //     } catch (IllegalStateException ise) {
    //         return cast(int) hashOf(typeid(o).toString());
    //     }
    // }
    ...
    //  * @serial include
    //  */
    // private static class SecureSet!(E) : AbstractSet!(E) {

    //     private enum long serialVersionUID = 7911754171111800359L;
    ...
    //      *      If {@code which == 2}, this is a credential
    ...
    //     this(Subject subject, int which) {
    //         this.subject = subject;
    //         this.which = which;
    //         this.elements = new LinkedList!(E)();
    //     }

    //     this(Subject subject, int which, Set!E set) {
    //         this.subject = subject;
    //         this.which = which;
    ...
    //     static AuthPermission DO_AS_PERMISSION =
    //         new AuthPermission("doAs");

    //     static AuthPermission DO_AS_PRIVILEGED_PERMISSION =
    //         new AuthPermission("doAsPrivileged");

    //     static AuthPermission SET_READ_ONLY_PERMISSION =
    //         new AuthPermission("setReadOnly");

    //     static AuthPermission GET_SUBJECT_PERMISSION =
    //         new AuthPermission("getSubject");

    //     static AuthPermission MODIFY_PRINCIPALS_PERMISSION =
    //         new AuthPermission("modifyPrincipals");

    //     static AuthPermission MODIFY_PUBLIC_CREDENTIALS_PERMISSION =
    //         new AuthPermission("modifyPublicCredentials");

    //     static AuthPermission MODIFY_PRIVATE_CREDENTIALS_PERMISSION =
