module hunt.security.AuthPermission;

import hunt.security.BasicPermission;
 ...
 *
 */
public final class AuthPermission : BasicPermission {

    private enum long serialVersionUID = 5806031445061587174L;
     ...
     * @throws IllegalArgumentException if {@code name} is empty.
     */
    public this(string name, string actions) {
        // for backwards compatibility --
        // createLoginContext is deprecated in favor of createLoginContext.*
        super("createLoginContext" == name ?
