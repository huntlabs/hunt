 ...
 * associated parameters which some code (e.g. code using keys) needs
...
class AlgorithmId : DerEncoder {
    ...
    private bool constructedFromDer = true;
    ...
    private this(ObjectIdentifier oid, DerValue params){
        this.algid = oid;
        this.params = params;
     ...
     */
    final void encode(DerOutputStream o) {
        derEncode(o);
    }
    ...
    string getName() {
        ...
        return (algName is null) ? algid.toString() : algName;
    }
    ...
    byte[] getEncodedParams() {
        return (params is null) ? null : params.toByteArray();
    }
    ...
    override bool opEquals(Object other) {
        ...
        AlgorithmId aid = cast(AlgorithmId) other;
        if (aid !is null) {
            return equals(aid);
        } 
        ObjectIdentifier oid = cast(ObjectIdentifier) other;
        if (oid !is null) {
            return equals(oid);
        } else {
            return false;
     ...
     */
    final bool equals(ObjectIdentifier id) {
        return algid == id;
    }
    ...
    private static ObjectIdentifier algOID(string name) {
        ...
        //                 if (stdAlgName !is null) {
        //                     stdAlgName = stdAlgName.toUpperCase(Locale.ENGLISH);
        //                 }
        //                 if (stdAlgName !is null &&
        //                         oidTable.get(stdAlgName) is null) {
    ...
    private static bool initOidTable = false;
    private static Map!(string,ObjectIdentifier) oidTable;
    private __gshared static Map!(ObjectIdentifier,string) nameTable;
     ...
     */
    private enum int[] DH_data = [ 1, 2, 840, 113549, 1, 3, 1 ];
    private enum int[] DH_PKIX_data = [ 1, 2, 840, 10046, 2, 1 ];
    private enum int[] DSA_OIW_data = [ 1, 3, 14, 3, 2, 12 ];
    private enum int[] DSA_PKIX_data = [ 1, 2, 840, 10040, 4, 1 ];
    private enum int[] RSA_data = [ 2, 5, 8, 1, 1 ];
    private enum int[] RSAEncryption_data =
                                 [ 1, 2, 840, 113549, 1, 1, 1 ];

    __gshared static ObjectIdentifier DH_oid;
     ...
     */
    private enum int[] md2WithRSAEncryption_data =
                                       [ 1, 2, 840, 113549, 1, 1, 2 ];
    private enum int[] md5WithRSAEncryption_data =
                                       [ 1, 2, 840, 113549, 1, 1, 4 ];
    private enum int[] sha1WithRSAEncryption_data =
                                       [ 1, 2, 840, 113549, 1, 1, 5 ];
    private enum int[] sha1WithRSAEncryption_OIW_data =
                                       [ 1, 3, 14, 3, 2, 29 ];
    private enum int[] sha224WithRSAEncryption_data =
                                       [ 1, 2, 840, 113549, 1, 1, 14 ];
    private enum int[] sha256WithRSAEncryption_data =
                                       [ 1, 2, 840, 113549, 1, 1, 11 ];
    private enum int[] sha384WithRSAEncryption_data =
                                       [ 1, 2, 840, 113549, 1, 1, 12 ];
    private enum int[] sha512WithRSAEncryption_data =
                                       [ 1, 2, 840, 113549, 1, 1, 13 ];
    private enum int[] shaWithDSA_OIW_data =
                                       [ 1, 3, 14, 3, 2, 13 ];
    private enum int[] sha1WithDSA_OIW_data =
                                       [ 1, 3, 14, 3, 2, 27 ];
    private enum int[] dsaWithSHA1_PKIX_data =
                                       [ 1, 2, 840, 10040, 4, 3 ];

    __gshared static ObjectIdentifier md2WithRSAEncryption_oid;
    __gshared static ObjectIdentifier md5WithRSAEncryption_oid;
    __gshared static ObjectIdentifier sha1WithRSAEncryption_oid;
    __gshared static ObjectIdentifier sha1WithRSAEncryption_OIW_oid;
    __gshared static ObjectIdentifier sha224WithRSAEncryption_oid;
    __gshared static ObjectIdentifier sha256WithRSAEncryption_oid;
    __gshared static ObjectIdentifier sha384WithRSAEncryption_oid;
    __gshared static ObjectIdentifier sha512WithRSAEncryption_oid;
     ...
     * Parameters include values P and G, and may optionally specify
     ...
     * Parameters may include values P and G.
     ...
     * Parameters may include values P, Q, and G; or these may be
     * derived from
     ...
     */
    static string makeSigAlg(string digAlg, string encAlg) {
