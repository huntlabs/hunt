 ...
 * @since 1.4
 */
final class X500Principal : Principal {
     ...
     */
    enum string RFC1779 = "RFC1779";
    /**
     * RFC 2253 string format of Distinguished Names.
     */
    enum string RFC2253 = "RFC2253";
    /**
     * Canonical string format of Distinguished Names.
     */
    enum string CANONICAL = "CANONICAL";
     ...
     */
    this(string name) {
        this(name, Collections.emptyMap!(string, string)());
    }
    ...
    //         DerValue der = new DerValue(inputStream);
    ...
    override bool opEquals(Object o) {
        ...
        if (typeid(o) != typeid(X500Principal)) {
            return false;
        }
        X500Principal other = cast(X500Principal)o;
        return this.thisX500Name == other.thisX500Name;
    }
    ...
    //     thisX500Name = new X500Name(cast(byte[])s.readObject());
    // }
}
